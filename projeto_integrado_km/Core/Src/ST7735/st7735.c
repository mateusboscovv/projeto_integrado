...
void ST7735_Test()
{
	...
	ST7735_WriteString(0,0,"SUA VEZ, JOGADOR X", Font_11x18, WHITE, RED);
	HAL_Delay(1000);
	ST7735_DrawLines();
	HAL_Delay(1000);
...
{
	ST7735_FillScreen(BLACK);
	 /*for (int16_t x=60; x =x ; x=x) {
		ST7735_DrawLine(0, 0, x, ST7735_HEIGHT-1, BLUE);
	    HAL_Delay(0);
	  }*/



	  for (int16_t y=20; y = y; y=y) {
	    ST7735_DrawLine(10, 50, 79, 50, WHITE);
	    HAL_Delay(0);
	    ST7735_DrawLine(10, 20, 79, 20, WHITE);
	  	    HAL_Delay(0);

	  	    for (int16_t x=0; x < ST7735_WIDTH; x=x) {
			    ST7735_DrawLine(30, 70, 30, 5, BLUE);
			    HAL_Delay(0);
			    ST7735_DrawLine(60, 70, 60, 5, BLUE);
			    			    HAL_Delay(0);
	ST7735_WriteString(67,56,"X", Font_11x18, WHITE, BLACK);
	ST7735_WriteString(100,15,"PLACAR", Font_7x10, WHITE, BLACK);
	/*ST7735_WriteString(50,25,"JOGADOR 1", Font_7x10, WHITE, BLACK);
	ST7735_WriteString(50,55,"JOGADOR 2", Font_7x10, WHITE, BLACK);*/


			/* for(int16_t x= 5; x = x; x=x){
				 ST7735_DrawLine(5, 70, 20, 55, RED);
				 HAL_Delay(0);
				 ST7735_DrawLine(20, 70, 5, 55, GREEN);
				 HAL_Delay(0);
				/* for (int16_t y=20; y = y; y=y) {
				 	    ST7735_DrawLine(25, 5, 10, 50, WHITE);
				 	    HAL_Delay(0);
			 }
			  }*/
	 ...
	 for (int16_t y=20; y = y; y=y) {
	  	    ST7735_DrawLine(0, 20, 159, y, RED);
	  	    HAL_Delay(0);
	  	  }
...
/*
	  ...
	  for (int16_t y=0; y < ST7735_HEIGHT; y+=6) {
	    ST7735_DrawLine(0, ST7735_HEIGHT-1, ST7735_WIDTH-1, y, BLUE);
	    HAL_Delay(0);
	  }

	  ST7735_FillScreen(BLACK);
	  for (int16_t x=0; x < ST7735_WIDTH; x+=6) {
	    ST7735_DrawLine(ST7735_WIDTH-1, ST7735_HEIGHT-1, x, 0, GREEN);
	    HAL_Delay(0);
	  }
	  for (int16_t y=0; y < ST7735_HEIGHT; y+=6) {
